package com.ultimate.text.editer;
		 ...
		 if(SPEECH==false){
			 ...
			 tobj.speak(toSpeak, TextToSpeech.QUEUE_FLUSH, null);
				...
				new Spaek_Stop_Asynchronous().execute("null");
						 ...
						 SPEECH=false;
//							ProgressDialog dialogg = new ProgressDialog(pmTextEdit.this);
//							dialogg.setMessage("Working...");
//							dialogg.show();
							
							 tobj.speak("", TextToSpeech.QUEUE_FLUSH, null);
...
//			}
			...
			while(SPEECH){
				if(!tobj.isSpeaking())   SPEECH=false;
			}
